...
import com.ggj_linlithgow.gdx.core.Mask;
import com.ggj_linlithgow.gdx.core.Spotlight;
import com.ggj_linlithgow.gdx.core.actor.Beastie;
import com.ggj_linlithgow.gdx.core.actor.Player;
...
public class GameScreen implements Screen {
	...
	public GameScreen(final DisplayOld game) {
		this.game = game;
	...
	public void show() {
		...
		textStage.setViewport(new ExtendViewport(w, h));
